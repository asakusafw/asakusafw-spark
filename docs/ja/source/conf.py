...
javadoclinks = {
    ...
    'asakusafw-sdk-gradle-groovydoc': ('http://docs.asakusafw.com/0.8.2/release/gradle-plugins/%s.html', ""),
    'asakusa-spark-gradle-groovydoc': ('http://docs.asakusafw.com/asakusa-on-spark/0.3.2/release/gradle-plugins/%s.html', ""),
}
